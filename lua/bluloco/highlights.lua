...
function M.setup(config)
  ...
  -- blink.pairs
  hl("BlinkPairs", { fg = t.punctuation.hex })
  hl("BlinkPairsOrange", { fg = t.rainbowOrange.hex })
  hl("BlinkPairsPurple", { fg = t.rainbowViolet.hex })
  hl("BlinkPairsBlue", { fg = t.rainbowBlue.hex })
  hl("BlinkPairsUnmatched", { fg = t.error.hex })
