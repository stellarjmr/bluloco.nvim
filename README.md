...
This is a standalone, dependency-free rewrite derived from
[uloco/bluloco.nvim](https://github.com/uloco/bluloco.nvim),
which itself ports the popular Visual Studio Code Themes
[Bluloco Light](https://github.com/uloco/theme-bluloco-light) and
[Bluloco Dark](https://github.com/uloco/theme-bluloco-dark).

Compared to the original, this fork:

- Removes the `lush.nvim` runtime dependency (theme is applied directly via `vim.api.nvim_set_hl`)
- Ships a small native HSL utility for color manipulation
- Loads faster and uses less memory

Credit for the original theme design and highlight work goes to [@uloco](https://github.com/uloco) and contributors.
...
You can see a lot of screenshots of themed plugins in the upstream [wiki page](https://github.com/uloco/bluloco.nvim/wiki#screenshots).
No config needed, works out of the box.

## Install

Install Bluloco with your favorite package manager. No runtime dependencies are required.

### [packer](https://github.com/wbthomason/packer.nvim)

```lua
use 'stellarjmr/bluloco.nvim'
```
...
If you are also using lazygit as your git client, you might be interested in the upstream [wiki guide](https://github.com/uloco/bluloco.nvim/wiki/Lazygit-%E2%80%90-Delta-%E2%80%90-Bat-%E2%80%90-Auto-Style) to set it up correctly with bluloco.
Auto-dark light mode included.

## Contributing

Bugs and pull requests are welcome on this repository's [issues](https://github.com/stellarjmr/bluloco.nvim/issues) page — especially for missing plugin support.
